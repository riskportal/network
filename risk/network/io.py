...
class NetworkIO:
    ...
    def _assign_edge_lengths(self, G: nx.Graph) -> None:
        ...
        """
        G_transformed = _prepare_graph_for_edge_length_assignment(
            G,
            compute_sphere=self.compute_sphere,
            surface_depth=self.surface_depth,
        )
        _calculate_and_set_edge_lengths(G_transformed, self.compute_sphere)
...
def _calculate_and_set_edge_lengths(G: nx.Graph, compute_sphere: bool) -> None:
